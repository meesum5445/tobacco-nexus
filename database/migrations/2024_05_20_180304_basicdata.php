...
return new class extends Migration
{
    ...
    {   
        ...
        VALUES
        (2, 'STRIO CARTBOX PRO 510 BATTERY', 40, LOAD_FILE('D:/DB/tobacco-nexus/resources/myImages/myimages/strio_cartbox_pro_510_battery_-_default_png.webp'), 'STRIO Cartbox Pro 510 Battery, featuring a discreet carry design, an integrated 1000mAh battery, variable voltage ranging from 2.4-3.8V, and LED screen, and compatibility with up to 2G carts.', 1, 0, true, 1),
        (6, 'LOFE DOUBLE FUNCTION NINJA SYSTEM', 60, LOAD_FILE('D:/DB/tobacco-nexus/resources/myImages/myimages/lofe_ninja_pod_system_-_default_png.webp'), 'The Lofe Double Function Ninja System, featuring a double-function vape device that can utilize refillable pods or a 510 threaded cartridge.', 2, 4, true, 1),
        (10, 'HUNI BADGER PRO', 80, LOAD_FILE('D:/DB/tobacco-nexus/resources/myImages/myimages/huni_badger_pro_-_default_png.webp'), 'Discover the Huni Badger Pro Electric Dab Straw: precision engineering, versatile temperature control, USB-C charging, and a sleek digital display—all in one compact and portable device.', 3, true, 7, 1),
