...
<div class="container">
    @foreach ($listofproductsinwishlist as $product)
        <div class="product-item">
            ...
            <div class="flex align-item-centre">
                <form action="{{route('removefromwishlist', ['product_id' => $product->id])}}" method="POST">
                    @csrf
                    <input type="submit" value="Remove From Wish List"; class="inc-dec">
                </form>
            </div>      
